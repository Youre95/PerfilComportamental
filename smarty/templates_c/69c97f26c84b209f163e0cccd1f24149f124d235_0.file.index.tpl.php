<?php
/* Smarty version 3.1.29, created on 2016-10-26 13:14:29
  from "/opt/lampp/htdocs/perfilcomportamental/smarty/templates/index.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_581090150a7060_20889466',
  'file_dependency' => 
  array (
    '69c97f26c84b209f163e0cccd1f24149f124d235' => 
    array (
      0 => '/opt/lampp/htdocs/perfilcomportamental/smarty/templates/index.tpl',
      1 => 1477480210,
      2 => 'file',
    ),
  ),
...
function content_581090150a7060_20889466 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="pt">
				...
				<div class="row tile_count">
					<div
						...
						<div class="right">
							<span class="count_top"><i class="fa fa-users"></i>Total de
								Usuários</span>
							<div class="count green"><?php echo $_smarty_tpl->tpl_vars['totalUsers']->value;?>
</div>
					...
					<div
						...
						<div class="right">
							...
							<div class="count green"><?php echo $_smarty_tpl->tpl_vars['totalRespostas']->value;?>
</div>
					...
					<div
						...
						<div class="right">
							<span class="count_top"><i class="fa fa-institution"></i>
								Faculdades</span>
							<div class="count green"><?php echo $_smarty_tpl->tpl_vars['totalFacul']->value;?>
</div>
					...
					<div
						...
						<div class="right">
							...
							<div class="count green"><?php echo $_smarty_tpl->tpl_vars['totalCurso']->value;?>
</div>
					...
					<div class="col-md-6 col-sm-6 col-xs-12">
						<div class="x_panel">
							...
							<div class="x_content">
								...
								<CENTER><label>Total de respostas: </label> <span class="badge bg-green "><?php echo $_smarty_tpl->tpl_vars['totalRespostas']->value;?>
</span></CENTER>
							</div>
						</div>
					</div>
...
" /> 
		      <input type="hidden" id="tubarao" value="<?php echo $_smarty_tpl->tpl_vars['tubaraoPercent']->value;?>
" /> 
		      <input type="hidden" id="lobo" value="<?php echo $_smarty_tpl->tpl_vars['loboPercent']->value;?>
" /> 
		      <input type="hidden" id="aguia" value="<?php echo $_smarty_tpl->tpl_vars['aguiaPercent']->value;?>
" />
		      
		      <input type="hidden" id="resultadoGeral" value="<?php echo $_smarty_tpl->tpl_vars['resultadoGeral']->value;?>
" >
...
>
 ...
 type="text/javascript"
		src="js/maps/jquery-jvectormap-2.0.3.min.js"><?php echo '</script'; ?>
>
	<!-- <?php echo '<script'; ?>
 type="text/javascript"	src="js/maps/jquery-jvectormap-1.2.2.min.js"><?php echo '</script'; ?>
> -->
	<?php echo '<script'; ?>
...
>
	<?php echo '<script'; ?>
 type="text/javascript"
		src="js/maps/jquery-jvectormap-world-mill-en.js"><?php echo '</script'; ?>
>
	<?php echo '<script'; ?>
 type="text/javascript"
		src="js/maps/jquery-jvectormap-us-aea-en.js"><?php echo '</script'; ?>
>
	<!-- pace -->
	<?php echo '<script'; ?>
...
>
	...
	<?php echo '<script'; ?>
 type="text/javascript" src="js/maps/brazil.js"><?php echo '</script'; ?>
>
